...
from _paths import RAW_DATA_ROOT, SEGMENTATION_ROOT
...
for marker in markers:
    ...
    # Recursively find all *c0*-1040.tiff matches regardless of subdirectory depth
